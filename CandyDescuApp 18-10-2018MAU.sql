...
MySQL - 10.1.36-MariaDB : Database - candydecuapp
*********************************************************************
*/
...
insert  into `cd_usuario_tb`(`cd_usu_cedula`,`cd_usu_nombre`,`cd_usu_ape1`,`cd_usu_ape2`) values (504080437,'Alberth','Espinoza','Ortiz');
